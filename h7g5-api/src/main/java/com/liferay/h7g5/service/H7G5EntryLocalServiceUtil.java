...
public class H7G5EntryLocalServiceUtil {
	...
	public static List<H7G5Entry> DynamicGetData(long id) {
		return getService().DynamicGetData(id);
	}

	public static H7G5Entry DynamicGetH_G_NData(
		long id, String Description, String Name) {

		return getService().DynamicGetH_G_NData(id, Description, Name);
	}

	public static H7G5Entry DynamicGetKeyData(String Key) {
		return getService().DynamicGetKeyData(Key);
	}

	public static List<H7G5Entry> DynamicGetNameData(String Name) {
		return getService().DynamicGetNameData(Name);
	}
	...
	public static void setService(H7G5EntryLocalService service) {
		_service = service;
	}
