...
public class H7G5EntryLocalServiceWrapper
	...
	@Override
	public java.util.List<com.liferay.h7g5.model.H7G5Entry> DynamicGetData(
		long id) {

		return _h7g5EntryLocalService.DynamicGetData(id);
	}

	@Override
	public com.liferay.h7g5.model.H7G5Entry DynamicGetH_G_NData(
		long id, String Description, String Name) {

		return _h7g5EntryLocalService.DynamicGetH_G_NData(
			id, Description, Name);
	}

	@Override
	public com.liferay.h7g5.model.H7G5Entry DynamicGetKeyData(String Key) {
		return _h7g5EntryLocalService.DynamicGetKeyData(Key);
	}

	@Override
	public java.util.List<com.liferay.h7g5.model.H7G5Entry> DynamicGetNameData(
		String Name) {

		return _h7g5EntryLocalService.DynamicGetNameData(Name);
	}
